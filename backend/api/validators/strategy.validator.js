...
const numericKeys = new Set(['targetMetric', 'currentMetric', 'progress', 'budgetNeed', 'capitalNeed', 'capitalImpact', 'probability', 'confidence']);
...
function body(value = {}) {
  const source = assertPlainObject(value, 'Strategy payload');
  const next = {};
...
export const strategyValidator = {
  body: { body },
  update: { params, body },
  params: { params }
};
