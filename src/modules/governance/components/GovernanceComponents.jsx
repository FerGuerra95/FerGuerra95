...
export const governanceCss = `
  ...
  .governance-enterprise-panel::before { content: ""; position: absolute; inset: -30%; z-index: 0; pointer-events: none; background: radial-gradient(circle at 0% 10%, rgba(14,165,233,0.092), transparent 34%), radial-gradient(circle at 100% 8%, rgba(59,130,246,0.070), transparent 38%), radial-gradient(circle at 54% 120%, rgba(255,255,255,0.030), transparent 42%); filter: blur(26px); opacity: 0.58; mix-blend-mode: screen; }
  .governance-enterprise-panel::after { content: ""; position: absolute; inset: 1px; z-index: 0; pointer-events: none; border-radius: inherit; background: linear-gradient(135deg, rgba(255,255,255,0.060), rgba(255,255,255,0.012) 32%, transparent 58%, rgba(255,255,255,0.020)); opacity: 0.30; }
  .governance-enterprise-panel > * { position: relative; z-index: 1; }
